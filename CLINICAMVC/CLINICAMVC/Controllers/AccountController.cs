...
namespace CLINICAMVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult CambiarConntrasena(string id,RegisterViewModel model)
        {
            try
            {
                using (var context = ApplicationDbContext.Create())
                {
                    ...
                    var resultado = up.ModificarContrasena(id, model);
                    if (!resultado)
                    {
                        return View(model);
                    }
        ...
        //autorizacion de porx

        //public ActionResult CargarEmpleado(string nombre)
        //{
        //    //using(var context = ApplicationDbContext.Create())
        //    //{
        //    //    var ep = new EmpleadosPorx(context);
        //    //    var empleados = ep.BuscarEmpleadosID(idemp);
        //    //    return View(empleados);
        //    //}
        //    ViewBag.nombreemp = nombre;
        //    return View();
        //}
        ...
        public ActionResult RegistroUsuario()
        {
            using(var context = ApplicationDbContext.Create())
            {
                var rolporx = new RolPorx(context);
                ViewBag.Roles = new SelectList(rolporx.RolesList());
                return View();
            }
            ...
            using(var context = ApplicationDbContext.Create())
            {
                ...
                try
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        var usuarioDNI = up.BuscarUsuarioDNI(model.DirEmpleado);
                        if(usuarioDNI != null)
                        {
        ...
        public ActionResult EditarUsuario(string id)
        {
            using (var context = ApplicationDbContext.Create())
            {
                ...
                if (usuarioid == null) return RedirectToAction("ConsultaUsuario", "Usuario");
        ...
        public ActionResult EditarUsuario(string id, RegisterViewModel model)
        {
            try
            {
                using (var context = ApplicationDbContext.Create())
                {
                    ...
                    if (!resultado) return View(model);
                    return RedirectToAction("ConsultaUsuario", "Usuario");
                }
            }
            catch 
